...
${chalk.blue.italic('📶 🇱🇰 Connecting to WhatsApp...▶')}`);
    ...
    conn.on('open', async () => {
        ...
        console.log(
            chalk.blueBright.italic('🇱🇰 Installing plugins...▶️')
        );
        ...
        console.log(
            chalk.blueBright.italic('⎝🌲Ҝ丨几Ꮆ🌲⎠ WhatsApp User Bot V1.0.0')
        );
    ...
    setInterval(async () => { 
        if (config.AUTOBIO == 'true') {
            if (conn.user.jid.startsWith('90')) { 
                ...
                const biography = '📅 ' + utch + '\n⌚ ' + ov_time + '\n\nPOWERD BY ⎝🌲Ҝ丨几Ꮆ🌲⎠ WhatsApp User Bot '
